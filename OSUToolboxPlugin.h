...
#include "OSUToolbox/OSUToolboxDLLExport.h"

/**
 * @brief The OSUToolboxPlugin class
 */
class OSUToolbox_EXPORT OSUToolboxPlugin : public QObject, public ISIMPLibPlugin
{
    Q_OBJECT
    Q_INTERFACES(ISIMPLibPlugin)
    Q_PLUGIN_METADATA(IID "com.your.domain.OSUToolboxPlugin")
  ...
  private:
    ...
    OSUToolboxPlugin(const OSUToolboxPlugin&); // Copy Constructor Not Implemented
    void operator=(const OSUToolboxPlugin&); // Operator '=' Not Implemented
};
